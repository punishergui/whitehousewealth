      ...
      <div className="flex items-start gap-3">
        ...
        <div className="flex-shrink-0">
          ...
          <div className="flex justify-center mt-1">
            <div className="w-1 h-1 rounded-full bg-emerald-400 animate-pulse shadow-[0_0_4px_rgba(16,185,129,0.8)]" />
          </div>
        </div>
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2 mb-2">
            ...
            <p className="text-[10px] text-white/30">Morning Briefing</p>
          </div>
          ...
          <div className="mt-3 pt-3 border-t border-white/[0.06]">
            <Link
              href="/hermes"
              className="inline-flex items-center gap-1.5 text-xs text-blue-400 hover:text-blue-300 font-medium transition-colors duration-200 group"
            >
              <span>Open Hermes Chat</span>
